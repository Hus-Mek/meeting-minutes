...
| --- | --- | --- |
| «توصية موجزة عالية المستوى» | «الجهة المسؤولة» | «التاريخ أو —» |
...
- نتائج الاجتماع: **اجمع المهام والتوصيات المتقاربة في توصيات قليلة عالية المستوى** (لا تُدرج كل مهمة فردية على حدة)، تمامًا كما في النموذج الرسمي. **عمود «المسؤول» هو الجهة/الشركة المسؤولة** (مثل: «شركة هوّز»، «الإدارة العامة للتراخيص») **وليس اسم شخص أبدًا**؛ طابق كل شخص بجهته من قائمة الحضور، وإن وردت المهمة باسم شخص (كما في مسودة read.ai) فاستبدله بجهته. اترك التاريخ فارغًا (—) إن لم يُذكر.
